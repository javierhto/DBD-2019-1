        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                	...
                	<div class="card-body">            
                    <form action="/admin/adminModificaAsignatura/{{ $asignatura->id }}" method="post">
                    ...
                    <div class="form-group row">                    
                      ...
                      <div class="col-md-8">
        				...
        				<div class="modal-footer">
	          				...
	          				<button type="button" class="btn btn-danger btn-galaxy" data-dismiss="modal" onClick= "window.location='{{ url("/admin/adminAsignaturas") }}' ">
	          					Volver
	          				</button>
        				</div>      		
				    </form>
