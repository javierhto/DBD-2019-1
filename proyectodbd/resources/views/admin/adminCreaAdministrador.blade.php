...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Ingresar Administrador </div>
                ...
                <form action="{{route('GuardaAdministrador')}}" method="post" >
                    @csrf
                    <div class="row">
                        ...
                        <a href="{{route('AdminAdministradores')}}" class="btn btn-sm btn-success"> Atras </a>
