        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                	...
                	<div class="card-body">            
                    <form action="/coordinador/coordinadorModificaCoordinacion/{{$coordinacion->id }}" method="post">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-8">
        				...
        				<div class="modal-footer">
	          				...
	          				<button type="button" class="btn btn-danger btn-galaxy" data-dismiss="modal" onclick="history.back()">
	          					Volver
	          				</button>
        				</div>      		
				    </form>
